...
def _enforce_size_limit() -> None:
    ...
    with _EVICTION_LOCK:
        ...
        # Normalization (finite fallback + clamp) lives in config so the env
        # docs, config value, and sweep behavior cannot drift apart.
        from src.utils import config

        ratio = config.cache_eviction_target_ratio()
